...
'''
def main():
    print("1 TESTING reverse('testing')")
    print(reverse('testing'))
    print()
    print("2 TESTING acronym('greatest of all time)')")
    print(acronym('greatest of all time'))
    print()
    print("3 TESTING whichTriangle(4, 6, 5)")
    print(whichTriangle(4,6,5))
    print()
    print("---whichTriangle(3,3,3)")
    print(whichTriangle(3,3,3))
    print()
    print("---whichTriangle(2,3,3)")
    print(whichTriangle(2,3,3))
    print()
    print("4 TESTING scrabble('jax')==17")
    print(scrabble('jax'))
    print()
    print("5 TESTING armstrong(153)")
    print(armstrong(153))
    print()
    print("6 TESTING primeFactors()")
    # print(primeFactors())
    print()
    print("7 TESTING pangram()")
    # print(pangram)
    print()
    print("8 TESTING sort()")
    # print(sort())
    print()
    print("9 TESTING rotate()")
    # print(rotate())
    print()
    print("10 TESTING evenAndOdds()")
    # print(evenAndOdds())
'''
...
def whichTriangle(sideOne, sideTwo, sideThree):
    for s in (sideOne, sideTwo, sideThree):
        s = float(s)
